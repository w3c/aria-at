...
const processTestDirectory = async ({ directory, args = {} }) => {
  ...
  const titleFormat = /^[A-Z][A-Za-z'\s]+(\s[A-Za-z'\s]+){2,}[^.]$/;
  ...
  const assertionStatementFormat = /^[A-Z][A-Za-z'(){}|\s]+(\s[A-Za-z'(){}|\s]+){2,}[A-Za-z']?$/;
  const assertionPhraseFormat = /^[a-z][A-Za-z'(){}|\s]+(\s[A-Za-z'(){}|\s]+){2,}[A-Za-z']?$/;
  ...
  const setupScriptDescription = /^[a-z][A-Za-z'(){}|\s]+(\s[A-Za-z'(){}|\s]+){2,}[A-Za-z']?$/;
