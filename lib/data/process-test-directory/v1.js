    ...
    function addSetupScript(scriptName) {
      ...
      if (scriptName) {
        if (!scriptsRecord.find(`${scriptName}.js`).isFile()) {
          utils.addTestError(test.testId, `Setup script does not exist: ${scriptName}.js`);
          return '';
        }
...
`;
  ...
  return { isSuccessfulRun: this.errorCount === 0, suppressedMessages: log.suppressedMessages() };
};
